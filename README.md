...
This is still a work in progress. Check out the [progress](timwis/soda-geoservices#1) and [tests](test/soda-geoservices.js) to get an idea for the functionality.
